...
Webflow.require('ix').init([
  ...
  //{"slug":"introelements","name":"introelements","value":{"style":{"opacity":0,"x":"-100px","y":"0px"},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":900},{"opacity":1,"transition":"transform 400ms ease 0ms, opacity 400ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  //{"slug":"main-div-download","name":"main div download","value":{"style":{"opacity":0,"scale":0.6},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"transform 300ms ease 0ms, opacity 500ms ease 0ms","scale":1}],"stepsB":[]}]}},

  {"slug":"introbutton","name":"introbutton","value":{"style":{"display":"block"},"triggers":[{"type":"click","selector":".popup-hellow","stepsA":[{"opacity":0,"transition":"opacity 400ms ease 0ms"},{"display":"none"}],"stepsB":[]}]}},
  {"slug":"next-button","name":"next-button","value":{"style":{},"triggers":[{"type":"click","selector":".img2","stepsA":[{"wait":500,"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"},{"transition":"transform 400ms ease 0ms","x":"0px","y":"-140px"}],"stepsB":[]},{"type":"click","selector":".flying-num","stepsA":[{"display":"block","opacity":0,"transition":"transform 300ms ease 0ms, opacity 300ms ease 0ms","x":"0px","y":"0px","scale":0.5,"rotate":"180deg"},{"wait":300},{"opacity":1,"transition":"transform 300ms ease 0ms, opacity 300ms ease 0ms","scale":1.0,"rotate":"0deg"}],"stepsB":[]},{"type":"click","selector":".discount-num-cont","stepsA":[{"display":"block","opacity":0,"wait":500,"transition":"transform 500ms ease 0ms, opacity 300ms ease 0ms","x":"0px","y":"130px"},{"wait":340},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 400ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]},{"type":"click","selector":".container-arrows-past","stepsA":[{"wait":200},{"display":"block","opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"20px"},{"wait":200},{"opacity":1,"transition":"transform 300ms ease 0ms, opacity 300ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"flying-num","name":"flying num","value":{"style":{"display":"block","opacity":1.0,"scale":0.5,"rotate":"130deg"},"triggers":[]}},
  {"slug":"reload-icon","name":"reload icon","value":{"style":{"opacity":0},"triggers":[]}},
  {"slug":"percenta","name":"percenta","value":{"style":{},"triggers":[]}},
  {"slug":"percenta-appiarence","name":"percenta appiarence","value":{"style":{},"triggers":[{"type":"click","selector":".price-img2","stepsA":[{"wait":400},{"display":"block","opacity":1,"transition":"transform 730ms ease 0ms, opacity 730ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[{"wait":400},{"opacity":0,"transition":"transform 730ms ease 0ms, opacity 730ms ease 0ms","x":"0px","y":"13px"},{"display":"none"}]}]}},
  {"slug":"socila-hover","name":"socila hover","value":{"style":{},"triggers":[{"type":"hover","selector":".social-ico-container","descend":true,"stepsA":[{"transition":"transform 500ms ease 0ms","x":"-240px","y":"0px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}]}]}},
  {"slug":"bage","name":"bage","value":{"style":{"x":"0px","y":"-140px"},"triggers":[]}},
  {"slug":"percenta-2","name":"percenta 2","value":{"style":{},"triggers":[]}},
  {"slug":"percenta-3","name":"percenta 3","value":{"style":{},"triggers":[]}},
  //{"slug":"new-interaction","name":"New Interaction","value":{"style":{},"triggers":[{"type":"hover","selector":".soc-sec-inside","descend":true,"stepsA":[{"wait":300},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"-130px","y":"0px"}],"stepsB":[{"wait":300},{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}]}]}},
  //{"slug":"new-interaction-2","name":"New Interaction 2","value":{"style":{},"triggers":[{"type":"hover","selector":".soc-sec-inside","descend":true,"stepsA":[{"wait":300},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"-130px","y":"0px"}],"stepsB":[{"wait":300},{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}]}]}},
  {"slug":"plus-social","name":"plus-social","value":{"style":{},"triggers":[{"type":"hover","selector":".social","stepsA":[{"transition":"transform 500ms ease 0ms","rotate":"90deg"}],"stepsB":[{"transition":"transform 500ms ease 0ms","rotate":"0deg"}]}]}},
  {"slug":"arrow-load","name":"arrow-load","value":{"style":{"opacity":0,"x":"100px","y":"0px"},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  //{"slug":"new-interaction-3","name":"New Interaction 3","value":{"style":{},"triggers":[]}},

  {"slug":"socials","name":"socials","value":{"style":{"display":"none","opacity":0},"triggers":[]}},
  {"slug":"add-clicks-plusbutton","name":"add-clicks-plusbutton","value":{"style":{},"triggers":[{"type":"click","selector":".popup-socials","stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"background-color": "rgba(15, 26, 33, 0.7)"}]}]}},
  {"slug":"close-social-buttonx","name":"close-social-buttonX","value":{"style":{},"triggers":[{"type":"click","selector":".popup-socials","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none"}],"stepsB":[]}]}},


    // Nick
    {"slug":"login-div-bg","name":"login-div-bg","value":{"style":{"display":"none","opacity":0,"scale":0.8},"triggers":[]}},
    {"slug":"login-button","name":"login-button","value":{"style":{},"triggers":[{"type":"click","selector":".login-div","stepsA":[{"wait":300},{"display":"block","opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":1}],"stepsB":[]}]}},
    {"slug":"close-login-div","name":"close-login-div","value":{"style":{},"triggers":[{"type":"click","selector":".login-div","stepsA":[{"wait":300},{"opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":0.8},{"display":"none"}],"stepsB":[]}]}},

    {"slug":"take-button","name":"take-button","value":{"style":{},"triggers":[{"type":"click","selector":".take-div","stepsA":[{"wait":300},{"display":"block","opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":1}],"stepsB":[]}]}},
    {"slug":"take-div-bg","name":"take-div-bg","value":{"style":{"display":"none","opacity":0,"scale":0.8},"triggers":[]}},
    {"slug":"close-take-div","name":"close-take-div","value":{"style":{},"triggers":[{"type":"click","selector":".take-div","stepsA":[{"wait":300},{"opacity":0,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":0.8},{"display":"none"}],"stepsB":[]}]}},

    // Coupon
    {"slug":"paper","name":"paper","value":{"style":{"opacity":1},"triggers":[]}},
    {"slug":"info-block","name":"info-block","value":{"style":{"opacity":1,"x":"0px","y":"300px"},"triggers":[{"type":"hover","selector":".stamp","stepsA":[],"stepsB":[{"opacity":0,"wait":200,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"79px"},{"display":"none"}]},{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]},{"type":"load","selector":".img-bg","preload":true,"stepsA":[{"wait":600},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"-200px"}],"stepsB":[]},{"type":"load","selector":".mainsection-env","stepsA":[{"wait":1000},{"display":"block","opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
    {"slug":"block-main","name":"block-main","value":{"style":{"display":"none","opacity":0,"x":"0px","y":"70px"},"triggers":[]}},
    {"slug":"use-button","name":"use button","value":{"style":{},"triggers":[{"type":"click","selector":".stamp","stepsA":[{"display":"block","opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":0.87}],"stepsB":[]},{"type":"click","selector":".mainsection-env","stepsA":[{"opacity":0.1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
    {"slug":"stamp","name":"stamp","value":{"style":{"display":"none","opacity":1,"scale":1.12},"triggers":[]}},
    {"slug":"load-bg","name":"load-bg","value":{"style":{},"triggers":[]}},
